...
from reference.merchant.models import Cart, Checkout
from reference.merchant.policy import rolling_spend_minor
from reference.merchant.trace import emit
from reference.merchant.mandate import compute_cart_hash
...
def checkout_initiate(cart_id: int, delivery_address: str, client_id: str, trace_id: str = None) -> dict:
    ...
    with Session(engine) as session:
        ...
        checkout = Checkout(
            ...
            cart_snapshot_json=cart.items_json,
            cart_version=1,
