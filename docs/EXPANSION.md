...
- **No engine creep:** any step shaped like auto-discounts, rules, bots, or stalled-loops fails review on sight in v1 (SPEC §13). Static prices, manual edits only.
...
|---|---|---|---|
| 8-door Merchant trait (doors, shapes, codes) | Sidecar S2 | Merchant-site M3 | `SPEC.md` §5 + both plan phases + trait conformance suite |
