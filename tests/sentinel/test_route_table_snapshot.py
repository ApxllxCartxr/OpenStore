...
_REGISTRY_TO_APP = {
    ...
    "/merchandising/<rule_id>/approve": "/merchandising/{rule_id}/approve",
    "/merchandising/<rule_id>/reject": "/merchandising/{rule_id}/reject",
    "/merchandising/<rule_id>/pause": "/merchandising/{rule_id}/pause",
    ...
    "/web/order/<checkout_id>": "/web/order/{checkout_id}",
    "/web/order/<checkout_id>/cancel": "/web/order/{checkout_id}/cancel",
}
